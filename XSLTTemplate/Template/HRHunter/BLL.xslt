...
namespace </xsl:text>
		<xsl:value-of select="entity/@namespaceBLL"/>
		<xsl:text>
{
</xsl:text>
	...
	{
		// Get an instance of the <xsl:value-of select="@name"/> DAL
	    // Making this static will cache the DAL instance after the initial load
	    private static readonly <xsl:value-of select="@namespaceDAL"/>.<xsl:value-of select="@name"/> dal = new <xsl:value-of select="@namespaceDAL"/>.<xsl:value-of select="@name"/>();
